...
execute if score *statics _six matches 1 store result score *x _six as 358a978f-e286-48d3-bcde-81106c020d2f at @s run function six:_/impl/decimal/sign/main_static
