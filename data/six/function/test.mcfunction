...
data modify storage six:in difference.a set value ["a", "b", "c", "d", "e"]
data modify storage six:in difference.b set value ["e", "f", "a", "l", "c", "oo", "k"]
data modify storage six:in difference.ordered set value true
tellraw @a ["DIFFERENCE IN: ", {'storage':'six:in', 'nbt':'difference'}]
function six:set/difference
tellraw @a ["DIFFERENCE OUT: ", {'storage':'six:out', 'nbt':'difference'}]

data modify storage six:in difference.a set value ["a", "b", "c", "d", "e"]
data modify storage six:in difference.b set value ["e", "f", "a", "l", "c", "oo", "k"]
data modify storage six:in difference.ordered set value false
tellraw @a ["DIFFERENCE IN: ", {'storage':'six:in', 'nbt':'difference'}]
function six:set/difference
tellraw @a ["DIFFERENCE OUT: ", {'storage':'six:out', 'nbt':'difference'}]

data modify storage six:in difference.a set value [{a:1, b:1}, {a:2, b:1}, {a:3, b:1}, {a:4, b:1}]
data modify storage six:in difference.b set value [{a:2, b:2}, {a:4, b:2}, {a:5, b:2}, {a:6, b:2}, {a:9, b:2}, {a:8, b:2}]
data modify storage six:in difference.by set value {command:'function six:compound/partial', in:'six:in partial.compound', out:'six:out partial.result', pre_run:'data modify storage six:in partial.get set value {only:["a"]}'}
data modify storage six:in difference.ordered set value true
tellraw @a ["DIFFERENCE IN: ", {'storage':'six:in', 'nbt':'difference'}]
function six:set/difference
tellraw @a ["DIFFERENCE OUT: ", {'storage':'six:out', 'nbt':'difference'}]
