...
data modify storage six:_ impl.distinct.this_item set from storage six:_ impl.distinct.items[0]
...
data remove storage six:_ impl.distinct.items[0]
execute if data storage six:_ impl.distinct.items[0] run function six:_/impl/set/distinct/each_preserve