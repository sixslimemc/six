...
data modify storage six:api difference[-1].value set from storage six:_ eval[-1].in.b[0]
function six:_/impl/set/difference/ordered/gen_b_comp.1 with storage six:_ eval[-1].in
