#> six:_/impl/set/difference/direct/ordered/each_match
#--------------------
# ./each
#--------------------

execute store success score *x _six run data modify storage six:_ v.difference.matches[0].value set from storage six:_ v.difference.a_item.value
