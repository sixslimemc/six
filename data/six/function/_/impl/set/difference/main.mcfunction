...
data merge storage lambda:in {resolve:{direct:{in:'six:_ eval[-1].in.b[-1]', out:'six:_ v.difference.b_comp[-1].compare'}}}
...
data merge storage lambda:in {resolve:{direct:{in:'six:_ eval[-1].in.a[-1]', out:'six:_ v.difference.a_compare.compare'}}}
data modify storage lambda:in resolve.lambda set from storage six:_ eval[-1].in.by
function lambda:a/resolve
