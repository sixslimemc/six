...
execute if data storage six:_ v.difference.b_comp[-1].value run data modify storage six:out difference.b append from storage six:_ v.difference.b_comp[-1].value
