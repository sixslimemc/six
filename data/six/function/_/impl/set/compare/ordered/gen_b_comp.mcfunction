#> six:_/impl/set/compare/ordered/gen_b_comp
#--------------------
# ./do
#--------------------
...
data modify storage six:api compare[-1].value set from storage six:_ eval[-1].in.b[0]
function six:_/impl/set/compare/ordered/gen_b_comp.1 with storage six:_ eval[-1].in
...
execute if data storage six:_ eval[-1].in.b[0] run function six:_/impl/set/compare/ordered/gen_b_comp