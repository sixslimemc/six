...
execute if score *intersection.equal _six matches 1 run data modify storage six:out intersection.b append from storage six:_ v.intersection.matches[0].value
