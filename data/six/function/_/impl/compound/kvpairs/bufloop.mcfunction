...
# get {..entry.value}
function six:_/impl/compound/kvpairs/get_value with storage six:_ v.kvpairs.entry
...
function six:_/impl/compound/kvpairs/consume_buffer with storage six:_ x
