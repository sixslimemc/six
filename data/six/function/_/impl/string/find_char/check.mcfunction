...
execute if score *find_char.escaped _six matches 1 run return run function six:_/impl/string/find_char/descape

data modify storage six:_ v.find_char.this_char set string storage six:in find_char.string 0 1
